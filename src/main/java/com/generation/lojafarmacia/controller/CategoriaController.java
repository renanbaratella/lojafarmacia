...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>> getByNome(@PathVariable String tipo) {
		return ResponseEntity.ok(categoriaRepository.findAllByTipo(tipo));
	}

	@GetMapping("/tipopelaletra/{tipo}")
	public ResponseEntity<List<Categoria>> getByNomeStartingWith(@PathVariable String tipo) {
		return ResponseEntity.ok(categoriaRepository.findAllByTipoStartingWith(tipo));
	}

	@PostMapping
	public ResponseEntity<Categoria> postTipo(@Valid @RequestBody Categoria categoria) {
